...
extension Quotes {
    static let irish: [Passage] = [
        ...
        Passage(text: "Is trian den obair tús a chur.", source: "Seanfhocal", theme: .beginnings, subtheme: .theFirstAct),
        ...
        Passage(text: "Is é an dreoilín beagnach an t-éan is lú dá bhfuil againn, agus is airde a ghlór ná glór éan atá deich n-uaire níos troime ná é.", source: "Éaneolaíocht", theme: .beginnings, subtheme: .smallToLarge),
        ...
        Passage(text: "Bíonn suas le dhá chéad síol in aon bholgán amháin caisearbháin, agus ní theastaíonn ó cheann amháin acu ach scoilt i mballa.", source: "Luibheolaíocht", theme: .beginnings, subtheme: .smallToLarge),
        ...
        Passage(text: "Ní chodlaíonn an t-iora rua an geimhreadh ar fad. Dúisíonn sé lá bog i mí Eanáir, itheann sé cuid dá thaisce, agus téann sé a luí arís.", source: "Zó-eolaíocht", theme: .waiting, subtheme: .heldBack),
        ...
        // MARK: The long count
        Passage(text: "Is é an focal céanna, aimsir, atá ar an rud atá lasmuigh den fhuinneog agus ar an am atá ag imeacht. Agus is é a chuirtear le briathar freisin: an aimsir chaite.", source: "Gaeilge", theme: .waiting, subtheme: .theLongCount),
        ...
        Passage(text: "Trí chomhartha na gaoise: foighne, discréid, agus tuiscint ar a bhfuil le teacht.", source: "Trecheng Breth Féne, an 9ú haois", theme: .waiting, subtheme: .standingAndWatching),
        ...
        Passage(text: "Bhíodh duine ina shuí tríd an oíche i ngach teach solais amach ón gcósta, á chinntiú go raibh an lasair fós ag casadh. Tá siad uathoibríoch ar fad anois.", source: "Stair", theme: .waiting, subtheme: .standingAndWatching),
        ...
        Passage(text: "Gearrtar coill go talamh de réir timthrialla agus fásann sí aníos arís as an stoc. Ní deireadh don chrann é, agus maireann an stoc na céadta bliain amhlaidh.", source: "Foraoiseacht", theme: .renewal, subtheme: .cutAndComeAgain),
        ...
        Passage(text: "Nuair a chailleann portán crúb, fásann ceann nua air thar dhá shéasúr. Bíonn an chrúb nua níos lú ar dtús agus tagann sí chuici féin ina dhiaidh sin.", source: "Bitheolaíocht mhara", theme: .renewal, subtheme: .cutAndComeAgain),
        ...
        Passage(text: "Beathaíonn an turlach eallach sa samhradh san áit a raibh loch sa gheimhreadh. Ní ghlanann aon duine é agus ní líonann aon duine é.", source: "Tíreolaíocht", theme: .renewal, subtheme: .theTurningYear),
        ...
        Passage(text: "Ciallaíonn fómhar an séasúr agus an bhaint araon. Nuair a deirtear go bhfuil an fómhar istigh, ní faoin bhféilire atá an chaint.", source: "Gaeilge", theme: .renewal, subtheme: .theTurningYear),
        ...
        Passage(text: "Clapsholas, contráth, coineascar. Trí fhocal ar an aon uair an chloig amháin tráthnóna, agus níl aon cheann acu níos cirte ná a chéile.", source: "Gaeilge", theme: .light, subtheme: .theEdgesOfTheDay),
        ...
        Passage(text: "Is é an lon dubh is túisce a labhraíonn ar maidin, beagnach uair an chloig roimh éirí gréine, agus is é an gealbhan is déanaí.", source: "Éaneolaíocht", theme: .light, subtheme: .theEdgesOfTheDay),
        Passage(text: "Ní luíonn an ghrian ag an nóiméad céanna i nGaillimh agus i mBaile Átha Cliath. Bíonn tuairim is deich nóiméad idir an dá luí.", source: "Réalteolaíocht", theme: .light, subtheme: .theEdgesOfTheDay),
        ...
        Passage(text: "Bán an dath agus geal an lonrú. Bíonn léine bhán ann agus bíonn lá geal ann, agus is é geal a chuirtear le hainm an duine is ansa leat.", source: "Gaeilge", theme: .light, subtheme: .readingTheLight),
        ...
        Passage(text: "Splanc an focal ar an tintreach agus ar an smaoineamh a thagann gan choinne. Aon fhocal amháin a dhéanann an dá ghnó.", source: "Gaeilge", theme: .light, subtheme: .lightItself),
        ...
        Passage(text: "Fiche litir atá san ogham, iad ina gceithre aicme de chúig cinn. Is iad na strócanna a chomhairtear seachas an cruth a aithint.", source: "Seandálaíocht", theme: .pattern, subtheme: .counted),
        ...
        Passage(text: "Seinntear port faoi dhó nó trí huaire sula n-athraítear é, agus bíonn dhá chuid i ngach port, gach ceann acu á sheinm faoi dhó.", source: "Ceol", theme: .pattern, subtheme: .counted),
        Passage(text: "Tá timpeall daichead míle ráth agus lios fágtha sa tír, agus is minic a fheictear ceann acu ó cheann eile.", source: "Seandálaíocht", theme: .pattern, subtheme: .counted),
        ...
        Passage(text: "Athraíonn an Ghaeilge tús an fhocail lena fheistiú leis an bhfocal roimhe: cara, a chara, ár gcara. Ag an tosach a dhéantar an ceangal.", source: "Gaeilge", theme: .pattern, subtheme: .fittedTogether),
        ...
        Passage(text: "Freagraítear ceist sa Ghaeilge leis an mbriathar a cuireadh inti. Níl aon fhocal ann a fhreagraíonn gach ceist, agus mar sin ní féidir freagra a thabhairt gan éisteacht.", source: "Gaeilge", theme: .pattern, subtheme: .orderNamed),
        ...
        Passage(text: "Trí rud a dhéanann saor adhmaid: dlúthú gan tomhas, adhmad gan lúbadh, agus buille a bheith faoi smacht.", source: "Trecheng Breth Féne, an 9ú haois", theme: .pattern, subtheme: .orderNamed),
        ...
        Passage(text: "Tá níos mó créatúr beo i lán doirn de chré gairdín ná mar atá de dhaoine ar an domhan, agus níl ainm ar an gcuid is mó díobh go fóill.", source: "Bitheolaíocht", theme: .ground, subtheme: .theSoilItself),
        ...
        Passage(text: "Thugadh imircigh dorn cré óna ngort féin leo thar sáile agus choinnídís i mbosca í. Ní raibh aon úsáid léi, agus rinneadh amhlaidh ar aon nós.", source: "Béaloideas", theme: .ground, subtheme: .aPlaceYouAreFrom),
        ...
        Passage(text: "Trí rud mharbha a íoctar le beo: crann úll, coll, agus doire beannaithe. Ba throime an fíneáil astu ná as beithíoch.", source: "Trecheng Breth Féne, an 9ú haois", theme: .ground, subtheme: .aKeptPlace),
        ...
        Passage(text: "Tógtar cró beach isteach i mballa gairdín ó dheas, ionas go mbeidh na beacha as an ngaoth agus faoin ngrian. Cuid den bhalla a bhíonn ina theach acu.", source: "Beachaireacht", theme: .ground, subtheme: .aKeptPlace),
        Passage(text: "Ní chuirtear rud ar bith i lár lios ná ní bhaintear rud ar bith as. Sin an chúis go bhfuil an oiread sin de shean-Éirinn fós faoi fhéar.", source: "Seandálaíocht", theme: .ground, subtheme: .aKeptPlace),
        ...
        Passage(text: "Itheann an lon dubh caor sceiche agus fágann sé an síol cúpla míle ón gcrann a d'fhás é. Sin mar a shiúlann sceach.", source: "Éaneolaíocht", theme: .travel, subtheme: .howASeedGoes),
        ...
        Passage(text: "Greamaíonn ceann an chnádáin d'olann caorach agus de mhuinchille cóta. Tá crúca beag ar bharr gach deilge, agus scaoileann sé le haon tarraingt amháin.", source: "Luibheolaíocht", theme: .travel, subtheme: .howASeedGoes),
        ...
        Passage(text: "Leagadh bealach darach trasna portaigh i gContae an Longfoirt sa bhliain céad daichead a hocht roimh Chríost. Insíonn fáinní na gcrann an dáta go beacht.", source: "Seandálaíocht", theme: .travel, subtheme: .theRoad),
        ...
        Passage(text: "Tá seanbhóthar oilithreachta i Maigh Eo a théann siar chun sléibhe. Tóchar an t-ainm atá air: an bóthar a leagtar trasna talún bhoig.", source: "Béaloideas", theme: .travel, subtheme: .theRoad),
        ...
        Passage(text: "Tá seánra scéalta sa tSean-Ghaeilge nach bhfuil ann ach turas farraige. Imram an t-ainm orthu, agus ní bhíonn an t-oileán deireanach mar an gcéanna in aon dá cheann.", source: "Litríocht na Sean-Ghaeilge", theme: .travel, subtheme: .farOff),
        ...
        Passage(text: "Tagann an chadhan go hÉirinn ón nGraonlainn gach geimhreadh. Cadhan aonair a thugtar ar dhuine atá leis féin, ó bheith ag féachaint ar cheann acu ar an gcladach.", source: "Éaneolaíocht", theme: .travel, subtheme: .farOff),
        ...
        Passage(text: "Trí eochair a osclaíonn smaointe: meisce, muinín, agus grá.", source: "Trecheng Breth Féne, an 9ú haois", theme: .meeting, subtheme: .theMoment),
        ...
        Passage(text: "Ní bhíonn caora ar gach cuileann. Bíonn crainn fhireanna ann agus crainn bhaineanna, agus ní thagann caor ar bith mura mbíonn ceann de gach cineál i ngar dá chéile.", source: "Luibheolaíocht", theme: .meeting, subtheme: .twoThatNeedEachOther),
        ...
        Passage(text: "Tá teanga fhada ag an mbumbóg a shroicheann síos i mbláth na seamaire deirge. Níl aon bheach eile in Éirinn a shroicheann é.", source: "Feithideolaíocht", theme: .meeting, subtheme: .twoThatNeedEachOther),
        Passage(text: "Cuireann an chuach a hubh i nead na riabhóige, agus tá dath uibhe na riabhóige ag an ubh sin. Dhá éan atá ceangailte lena chéile cé nár roghnaigh ceachtar acu é.", source: "Éaneolaíocht", theme: .meeting, subtheme: .twoThatNeedEachOther),
        ...
        Passage(text: "Scaoileann an t-iúr fireann scamall pailine amach i mí an Mhárta. Mura bhfuil crann baineann laistigh de chúpla céad méadar de, ní tharlaíonn aon rud.", source: "Luibheolaíocht", theme: .meeting, subtheme: .twoThatNeedEachOther),
        ...
        Passage(text: "Bhí grád dlí ann, an briugu, nach raibh cead aige duine ar bith a eiteach. Bhí air teach a bheith aige ar bhóthar poiblí agus coire nach bhfolmhaítí riamh.", source: "Seandlíthe na hÉireann", theme: .meeting, subtheme: .theMannersOfIt),
        ...
        // MARK: Grown together
        Passage(text: "Nuair a bhíonn dhá ghéag ag cuimilt ar a chéile bliain i ndiaidh bliana, caitheann siad an choirt ar shiúl agus fásann an dá adhmad le chéile go dtí nach mbíonn iontu ach aon cheann amháin.", source: "Foraoiseacht", theme: .kinship, subtheme: .grownTogether),
        ...
        Passage(text: "Lánúin an focal ar bheirt atá ceangailte le chéile, agus sa tseandlí ní hé an lánúin phósta amháin a bhí i gceist: bhí an múinteoir agus a dhalta ina lánúin freisin.", source: "Seandlíthe na hÉireann", theme: .kinship, subtheme: .grownTogether),
        ...
        Passage(text: "Ní mharaíonn an t-eidhneán an crann a mbíonn sé air. Ní tharraingíonn sé bia ar bith as, agus beathaíonn sé an éanlaith nuair nach bhfuil aon rud eile ann.", source: "Luibheolaíocht", theme: .kinship, subtheme: .grownTogether),
        ...
        Passage(text: "Tá móinéar seanaimseartha ann nach bhfuil ann ach fréamhacha ceangailte: dhá scór speiceas ag fás trína chéile agus gan ceann acu in ann teacht slán leis féin.", source: "Éiceolaíocht", theme: .kinship, subtheme: .grownTogether),
        ...
        Passage(text: "Col ceathrair a thugtar ar chlann do dhearthár nó do dheirféar. Col an cosc pósta, agus is é an ceathrú céim den chosc sin atá san ainm ceana.", source: "Gaeilge", theme: .kinship, subtheme: .theWordsForIt),
        ...
        Passage(text: "Ciallaíonn clann do pháistí féin, agus ciallaíonn sí do shliocht go léir na céadta bliain ina dhiaidh sin. Ní athraíonn an focal.", source: "Gaeilge", theme: .kinship, subtheme: .theWordsForIt),
        ...
        Passage(text: "A rún a thugtar ar dhuine mór le duine eile. Rún an focal ar an rud nach n-insítear, agus is é an focal céanna atá ar an duine a d'inseofá dó é.", source: "Gaeilge", theme: .kinship, subtheme: .theWordsForIt),
        ...
        Passage(text: "Thabharfainn mo ríocht ghlórmhar agus mo chuid den oidhreacht, a dúirt Guaire lena dheartháir, ar a bheith i do chuideachta sa choill.", source: "Marbhán agus Guaire, an 10ú haois", theme: .kinship, subtheme: .twoPeople),
        ...
        Passage(text: "Dís a thugtaí ar bheirt a bhíonn le chéile go rialta. Níl an focal coitianta anois, ach tá sé sna scéalta i gcónaí.", source: "Gaeilge", theme: .kinship, subtheme: .twoPeople),
        ...
        Passage(text: "Fuaim na gaoithe i gcoill ghéagach faoi spéir ghorm, easanna abhann, agus glao na heala. Ceol álainn é sin, a scríobh manach sa deichiú haois.", source: "Marbhán agus Guaire, an 10ú haois", theme: .peace, subtheme: .quietAsASound),
        ...
        Passage(text: "Clagarnach a thugtar ar fhearthainn throm ar dhíon, brádán ar bháisteach chomh mín sin nach mothaítear í, agus ceobhrán ar an gceo atá eatarthu.", source: "Gaeilge", theme: .peace, subtheme: .quietAsASound),

        // MARK: The words for stopping
        Passage(text: "Síocháin ón bhfocal síth, agus is é an focal céanna atá ar an gcnoc ina raibh na daoine sí. Rianaítear an dá bhrí siar chuig fréamh a chiallaíonn suí agus fanacht.", source: "Sanasaíocht", theme: .peace, subtheme: .theWordsForStopping),
        Passage(text: "Daoine sí a thugtar ar an dream a bhí sa chnoc, agus is é an focal ar shíocháin atá ina n-ainm. Ainm cúramach a bhí ann seachas cur síos.", source: "Béaloideas", theme: .peace, subtheme: .theWordsForStopping),
        ...
        Passage(text: "Trí ghlas a dhúnann rúin: náire, tost, agus rúndacht.", source: "Trecheng Breth Féne, an 9ú haois", theme: .peace, subtheme: .theWordsForStopping),
        ...
        Passage(text: "Slán agat a deir an té atá ag imeacht, agus slán leat a deir an té atá ag fanacht. Deir an fhoirm cé acu a bhfuil an bóthar roimhe.", source: "Gaeilge", theme: .peace, subtheme: .theWordsForStopping),
        ...
        Passage(text: "Suaimhneas an focal ar an gciúnas atá istigh i nduine. Is féidir suaimhneas a bheith ort in áit atá lán de ghleo.", source: "Gaeilge", theme: .peace, subtheme: .theWordsForStopping),
        ...
        Passage(text: "An bhuíon is fearr ag seinm ceoil dom, agus gan duine acu ar tuarastal ar bith.", source: "Marbhán agus Guaire, an 10ú haois", theme: .peace, subtheme: .atEase),
        Passage(text: "Labhraíonn Suibhne le gach planda as a ainm féin: a bhiolair, a bharrghlasáin, ar bhruach thobar an loin.", source: "Buile Shuibhne, an 12ú haois", theme: .peace, subtheme: .atEase),
        ...
        Passage(text: "Suantraí ceann de na trí cheol a bhí ag an gcruitire, agus is é an t-aon cheann acu a raibh sé de dhualgas air an lucht éisteachta a chur a chodladh.", source: "Ceol", theme: .peace, subtheme: .atEase),
        ...
        Passage(text: "Tóg go bog é. Bog an focal ar rud atá mín agus ar rud atá mall, agus ar an talamh nach seasann faoi do chos.", source: "Gaeilge", theme: .peace, subtheme: .atEase),
